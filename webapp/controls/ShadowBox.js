sap.ui.define(
    ...
    function(Control) {
        ...
        return Control.extend("App.CustomControls.controls.ShadowBox",{
            metadata: {
                properties: {
                    width: {
            ...
            init: function() {
                ...
                var libraryPath = jQuery.sap.getModulePath("App/CustomControls"); //get the server location of the ui library
